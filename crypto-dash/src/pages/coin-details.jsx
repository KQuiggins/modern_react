                ...
                {!loading && !error && (
                    <>
                        ...
                        <div className="coin-details-info">
                            ...
                            <h4>Current Price: ${coin.market_data.current_price.usd.toLocaleString()}</h4>
                            ...
                            <h4>Price Change (24h): ${coin.market_data.price_change_24h.toFixed(2)}{` `} ${coin.market_data.price_change_percentage_24h.toFixed(2)}%</h4>
